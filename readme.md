...
[LastTAB-return](https://github.com/armor-cage/LastTAB-return/) - Browser extension (Chrome/Brave) for improved tab management. Back to last used tab, group manager, Drag & Drop, etc.
